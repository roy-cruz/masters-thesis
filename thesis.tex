...
\addcontentsline{exp}{chapter}{Appendix A: Offline Tracker Data Quality Monitoring Enhancements Through Data Exploration Tools} %Change title of Appendix A for List of Appendices
%\example{MATLAB CODE}
%\label{1st_ex}
\chapter*{Appendix A: Offline Tracker Data Quality Monitoring Enhancements Through Data Exploration Tools} %Change title of Appendix A
